...
| [0046](0046-client-answers-quotation-and-project-model.md) | Client answers: T&C page 2, dual-entry discount, manual status, no progress labels | Accepted | 2026-08-22 | Domain model / Product |
| [0047](0047-quotation-counter-forward-reseed.md) | Quotation counter — seeded once, forward-only manual re-seed (the "700XX next year" answer) | Accepted | 2026-08-22 | Domain model / Implementation |
